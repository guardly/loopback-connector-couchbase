...
CouchbaseDB.prototype.count = function (model, callback, where) {
	...
	EClog("CouchbaseDB.prototype.count() : " + typeof model); 
	//var loopback = require('loopback');
	//var app = loopback();
	//var modelobj = loopback.getModel(model,false);
	//EClog("CouchbaseDB.prototype.count() : " + JSON.stringify([model, app])); 
	//EClog("CouchbaseDB.prototype.count() loopback,app: " + JSON.stringify([loopback,app])); 
	//EClog("CouchbaseDB.prototype.count() app: " + app); 
	//EClog("CouchbaseDB.prototype.count() app.models: " + app.models); 
