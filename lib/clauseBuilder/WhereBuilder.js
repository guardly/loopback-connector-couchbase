...
var readSimpleElement = function(conds,theThis,constants,resultClause){
	...
	debug(spaces + "        readSimpleElement: resultClause   :   " + resultClause);
	return resultClause;
};
var readSimpleElementPart = function(conds,theThis,constants){
	debug(spaces + "        readSimpleElementPart: " + JSON.stringify([conds]));
	var self = theThis;
	var resultClause = '(';
